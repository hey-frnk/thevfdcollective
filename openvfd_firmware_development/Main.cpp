...
// g++ Main.cpp LED_Color.cpp LED_Color_Static.cpp LED_Color_Spectrum.cpp LED_Shared.cpp -DDEBUG -std=c++11 -Wall -o Main
...
void mChanger(LED_Color_Mode **mode) {
  ...
  else if(    dynamic_cast<LED_Color_Spectrum *>    (*mode))    {*mode = &led_static;       printf("Changed to Static fade\n");}
}
