...
#ifdef VFDCO_CONFIG_STM_CLASSIC
...
#ifdef VFDCO_CONFIG_STM_DAINTY
static uint16_t _vfdco_button_to_pin(uint8_t button) {
  switch(button) {
    case BUTTON_F1: return GPIO_PIN_8;
    case BUTTON_F2: return GPIO_PIN_1;
    case BUTTON_F3: return GPIO_PIN_1;
    case BUTTON_F4: return GPIO_PIN_6;
    default: return GPIO_PIN_8;
  }
  return GPIO_PIN_8;
}
...
static GPIO_TypeDef* _vfdco_button_to_port(uint8_t button) {
	switch(button) {
		...
		case BUTTON_F2: return GPIOA;
		case BUTTON_F3: return GPIOB;
		case BUTTON_F4: return GPIOA;
