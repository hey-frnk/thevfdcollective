...
{
public:
    fl_app_com(const QString portname, bool is_legacy_protocol);
    ~fl_app_com();
    ...
    void transfer_time_date(vfdco_time_t t, vfdco_date_t d); // Legacy: Fully compatible
    ...
    void transfer_clock_control(fl_app_com_control_t control); // Legacy: No HW request
private:
